...
class Dialog(object):
    ...
    def __init__(self, dialog="dialog", DIALOGRC=None,
        ...
        if 'pass_args_via_file' in kwargs: pass_args_via_file = kwargs['pass_args_via_file']; del kwargs['pass_args_via_file']
        else: pass_args_via_file = None
    ...
    def setup_debug(self, enable, file=None, always_flush=False, **kwargs):
        ...
        """
        if 'expand_file_opt' in kwargs: expand_file_opt = kwargs['expand_file_opt']; del kwargs['expand_file_opt']
        else: expand_file_opt = False
    ...
    def _call_program(self, cmdargs, **kwargs):
        ...
        *redir_child_stdin_from_fd*. The pipe allows the parent process
        ...
        if self.pass_args_via_file:
            ...
            filecontents = ' '.join( ( self._quote_arg_for_file_opt(arg)
    ...
    def gauge_start(self, text="", height=None, width=None, percent=0,
        ...
        with _OSErrorHandling():
            ...
            child_pid, child_output_rfd, args_file = self._call_program(
                ["--gauge", text, unicode(height), unicode(width),
                 unicode(percent)],
